...
exports.IAssetDataContract = void 0;
...
class IAssetDataContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = IAssetDataContract.deployedBytecode, encoderOverrides) {
        super('IAssetData', IAssetDataContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
