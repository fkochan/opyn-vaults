...
(function (IZeroExEvents) {
    IZeroExEvents["ExpiredRfqOrder"] = "ExpiredRfqOrder";
...
class IZeroExContract extends base_contract_1.BaseContract {
     ...
     */
    batchFill(fillData, minBuyAmount) {
        const self = this;
     ...
     */
    fillOtcOrder(order, makerSignature, takerTokenFillAmount, unwrapWeth) {
        const self = this;
        assert_1.assert.isBigNumber('takerTokenFillAmount', takerTokenFillAmount);
        assert_1.assert.isBoolean('unwrapWeth', unwrapWeth);
        const functionSignature = 'fillOtcOrder((address,address,uint128,uint128,address,address,address,uint256),(uint8,uint8,bytes32,bytes32),uint128,bool)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     */
    fillTakerSignedOtcOrder(order, makerSignature, takerSignature, unwrapWeth) {
        const self = this;
        assert_1.assert.isBoolean('unwrapWeth', unwrapWeth);
        const functionSignature = 'fillTakerSignedOtcOrder((address,address,uint128,uint128,address,address,address,uint256),(uint8,uint8,bytes32,bytes32),(uint8,uint8,bytes32,bytes32),bool)';
        return {
            sendTransactionAsync(txData, opts = { shouldValidate: true }) {
                return __awaiter(this, void 0, void 0, function* () {
                    const txDataWithDefaults = yield self._applyDefaultsToTxDataAsync(Object.assign({ data: this.getABIEncodedTransactionData() }, txData), this.estimateGasAsync.bind(this));
     ...
     */
    multiHopFill(fillData, minBuyAmount) {
        const self = this;
        assert_1.assert.isBigNumber('minBuyAmount', minBuyAmount);
