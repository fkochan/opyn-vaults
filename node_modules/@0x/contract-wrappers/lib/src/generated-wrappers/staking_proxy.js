...
exports.StakingProxyContract = exports.StakingProxyEvents = void 0;
...
class StakingProxyContract extends base_contract_1.BaseContract {
    constructor(address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode = StakingProxyContract.deployedBytecode, encoderOverrides) {
        super('StakingProxy', StakingProxyContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode, encoderOverrides);
