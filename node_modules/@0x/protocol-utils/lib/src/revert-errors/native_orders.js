...
exports.BatchFillIncompleteError = exports.OnlyOrderMakerAllowed = exports.FillOrKillFailedError = exports.CancelSaltTooLowError = exports.OrderNotFillableByTakerError = exports.OrderNotFillableBySenderError = exports.InvalidSignerError = exports.OrderNotSignedByTakerError = exports.OrderNotSignedByMakerError = exports.OrderNotFillableError = exports.OrderNotFillableByOriginError = exports.ProtocolFeeRefundFailed = void 0;
...
class OrderNotSignedByTakerError extends utils_1.RevertError {
    constructor(orderHash, signer, taker) {
        super('OrderNotSignedByTakerError', 'OrderNotSignedByTakerError(bytes32 orderHash, address signer, address taker)', {
            orderHash,
            signer,
            taker,
        });
...
exports.OrderNotSignedByTakerError = OrderNotSignedByTakerError;
